  ...
  const handleFormSubmit = async () => {
    let response = await fetch("https://varden.vercel.app/api/data", {
      ...
      body: JSON.stringify({
        ...
        PreferedMarket: prefMarket,
        GroupInvestment: radioState,
        NumInvestors: numInvestors,
      }), //JSON.stringify(jsonData) // body data type must match "Content-Type" header
    });
  };
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                <select
                  className="form-control"
                  placeholder="Asset Preference"
                  onChange={(e) => handleAssetPref(e)}
                >
                ...
                <label
                  ...
                  className="form-label"
                >
                  Do you have an investment group already?
                </label>
                <select
                  className="form-control"
                  placeholder="Asset Preference"
                  onChange={(e) => handleBool(e)}
                >
                  <option>Yes</option>
                  <option>
                    I would like to be matched with like-minded investors
                  </option>
                </select>
              </div>
            </div>
