...
const Home: NextPage = () => {
  ...
  const header1 =
    "Investment Package 1: High-end Commercial Real Estate Assets (office, industrial, retail, multifamily, hotel, developments)";
  const body1 =
    "Luxury real estate assets located in central business districts. Assets in this investment category will be above the 20 million dollar mark and have an “allure” factor that makes it a staple in its marketplace. Varden can structure investment groups around office, industrial, retail, multifamily, hotel, developments, and redevelopment ventures.";

  const header2 =
    "Investment Package 2: Middle-sized Commercial Assets (less robust and more affordable than assets in the first package)";
  const body2 =
    "The same commercial assets as investment package 1 at a more affordable cost. Assets in this category will be under the 20 million dollar mark and less robust than brand name developments in metropolitan cities. This investment package is perfect for investors looking to enter the commercial real estate market at a lower cost than class A and Trophy assets demand.";

  const header3 = "Investment Package 3: Short-term Airbnb rentals";
  const body3 =
    "This investment package solely focuses on short-term residential rental properties. In other words, Airbnb or vrbo properties. These assets generate income from short leases often driven by a popular vacation destination or heavy tourist destination.";
  ...
  const textHolder: text[] = [
    { header: header1, body: body1, display: row },
  ...
  return (
    <div style={{ backgroundColor: "#3D3D3D", height: "100%" }}>
      ...
      >
        ...
        >
          Investing in real estate just became easier and more profitable.
          Varden matches like-minded investors together and connects them with
          high-performing properties that fit with their investing goals,
          preferences, and conveniences. Properties will be structured as a
          multi-member LLC, and each member will purchase a share of ownership
          or equity (the group of members own 100% of the LLC). The LLC will be
          governed under an operating agreement that will allow the shareholders
          to make business decisions together, accrue a steady influx of
          revenue, and more.{" "}
        </p>
      </div>
      <div></div>
